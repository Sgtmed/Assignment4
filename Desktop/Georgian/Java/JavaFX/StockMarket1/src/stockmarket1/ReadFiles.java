...
public class ReadFiles
{
	public static void IfFileExists()
	{
		try
		{
			File file = new File("/Users/danbrost/Desktop/Georgian/Java/JavaFX/StockMarket1/newBBD.csv");
			if(file.exists())
			{
	...
	public static void NumberOfRows()
	{
		try
		{
			File file = new File("/Users/danbrost/Desktop/Georgian/Java/JavaFX/StockMarket/newBBD.csv");
	...
	{	
		...
		{	
			...
			{
				//.csv file where data is coming from
				String csvFile = "/Users/danbrost/Desktop/Georgian/Java/JavaFX/StockMarket/newBBD.csv";
